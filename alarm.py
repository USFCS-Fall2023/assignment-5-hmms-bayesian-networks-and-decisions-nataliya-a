...
print(q)
print("The probability of Mary Calling given that John called is", q.values[0])
...
print(q)
print("The probability of both John and Mary calling given Alarm is", q.values[0][0])

print("\n The probability of Alarm, given that Mary called")
q = alarm_infer.query(variables=["Alarm"],evidence={"MaryCalls":"yes"})
print(q)
print("The probability of Alarm, given that Mary called is", q.values[0])
